...
use JJFulfilment\AmazonSPAPI\Models\Feeds\CreateFeedDocumentResponse;
use JJFulfilment\AmazonSPAPI\Models\Feeds\FeedDocument;
...
class Document
{
    ...
    /**
     * @param JJFulfilment\AmazonSPAPI\Models\(Feeds\FeedDocument|Feeds\CreateFeedDocumentResponse) $documentInfo
     *      The payload of a successful call to createFeedDocument, or getFeedDocument
     * @param ?array['contentType' => string, 'name' => string] $documentType
     *      Must be one of the constants defined in the FeedType classes. When downloading a feed
    ...
    public function __construct(
        ...
        if (!(
            ...
            $msg = "documentInfo must be one of the following types: JJFulfilment\AmazonSPAPI\Models\Feeds\CreateFeedDocumentResponse, JJFulfilment\AmazonSPAPI\Models\Feeds\FeedDocument";
