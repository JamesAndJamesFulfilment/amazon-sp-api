...
'quantity' => 'getQuantity'    ];
     ...
     * Sets order_item_id
     *
     * @param string $order_item_id the unique identifier for the order item
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int $quantity the quantity of items that needs an update of the shipment status
     *
     * @return $this
     */
